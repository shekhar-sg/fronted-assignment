...
export const DiscoverAyurvedaSectionData = {
...
export const AyurvedicConsultationsSectionData = {
...
export const CustomerStoriesSectionData = {
...
export const AyurvedaExpertsSectionData = {
...
export const FooterData = {
  ...
  links: [
    ...
    {
      title: "For Businesses, Hotels and Resorts",
      url: "/*",
    },
  ],
  subscribe: "Subscribe to our Newsletter and join Amrutam Family today!",
};
